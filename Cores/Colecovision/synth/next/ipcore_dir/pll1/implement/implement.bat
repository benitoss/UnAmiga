...
xst -ifn xst.scr
move pll1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll1_exdes.ucf pll1_exdes

echo 'Running map'
map -timing -pr b pll1_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll1_exdes -w routed.ncd routed.v
cd ..
