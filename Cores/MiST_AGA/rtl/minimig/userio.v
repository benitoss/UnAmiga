...
//    if (~_xjoy2[3] && ~_xjoy2[2])
      t_osd_ctrl = KEY_MENU; // jepalza, necesario? el MIST usa hard y nosotros soft
//    else
      t_osd_ctrl = osd_ctrl;
end
...
//
//// mouse buttons
//assign _mleft  = 1'b0; //~mouse_btn[0];
//assign _mright = 1'b0; //~mouse_btn[1];
//assign _mthird = 1'b1; //~mouse_btn[2];
//--------------------------------------------------------------------------------------
//--------------------------------------------------------------------------------------
